...
public class NegativeTest {
    ...
    public void emptyNameInput() {
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+78805553535");
    ...
    public void incorrectPhoneInput() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("Vasya");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("button.button")).click();
